                        ...
                        <div class="row justify-content-center">
                                ...
                                <aside class="shop-sidebar">
                                    <div class="widget shop-widget">
                                        ...
                                        <div class="shop-cat-list">
                                            ...
                                            {
                                            ?>        
                                                <li class="<?= ($cusines_row['id'] == $_GET['category']) ? 'active':''; ?>"><a href="cusines_categories.php?category=<?php echo $cusines_row['id']; ?>"><?php echo $cusines_row['cusine_name']; ?> <span>+</span></a></li>
                                            <?php } ?>    
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="col-9">
                                ...
                                if(isset($_GET['category']))
                                {
                                  ...
                                  $query.="category='".$_GET['category']."' and";

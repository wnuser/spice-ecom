...
if(isset($_POST['delete_products'])) {
   ...
   $delete_tax_status=mysqli_query($con,"update our_products set is_active='0' where id='".$rec_id."' and is_active='1'");
    ...
    if($delete_tax_status==true) {
        ...
        $_SESSION['alert_msg']='<strong>Success!</strong> Deals Product Deleted.';
...
<html lang="en">
	<head>
		...
		<title>Blend Ur Spice - View Deals</title>
				...
				<div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<div class="col-auto">
								<a href="deals.php" class="btn btn-primary">
									<i class="fas fa-plus"></i>&nbsp;Add Deals
								</a>
							</div>
						</div>
					</div>
								...
								<div class="card-body">
									<div class="table-responsive">
										<table class="table table-center table-hover datatable">
											...
											<?php 
											$i=1;
											$product_details=mysqli_query($con,"select * from our_products where prd_type='1' and is_active='1'");
                        					...
                        					<!-- /Delete Tax Modal -->
												...
												<tr>
													...
													<td class="text-right">
														<a href="edit_deals.php?deals_id=<?php echo $product_details_row['id']; ?>" class="btn btn-sm btn-white text-success mr-2"><i class="far fa-edit mr-1"></i> Edit</a> 

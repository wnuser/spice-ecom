...
if(isset($_POST['delete_products'])) {
   ...
   $delete_tax_status=mysqli_query($con,"update our_products set is_active='0' where id='".$rec_id."' and is_active='1'");
    ...
    if($delete_tax_status==true) {
        ...
        $_SESSION['alert_msg']='<strong>Success!</strong> Seasoning Product Deleted.';
...
<html lang="en">
	<head>
		...
		<title>Eternal Seasoning - View Seasoning Mix</title>
						...
						<div class="row align-items-center">
							<div class="col">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">View Seasoning Mix</li>
								</ul>
							</div>
							<div class="col-auto">
								<a href="seasoning_mix.php" class="btn btn-primary">
									<i class="fas fa-plus"></i>&nbsp;Add Seasoning Mix
								</a>
							</div>
						</div>
					</div>
								...
								<div class="card-body">
									<div class="table-responsive">
										<table class="table table-center table-hover datatable">
											...
											<?php 
											$i=1;
											$product_details=mysqli_query($con,"select * from our_products where prd_type='2' and is_active='1'");
											while($product_details_row=mysqli_fetch_array($product_details))
											{
											
										    $seasoning_categorys=mysqli_fetch_array(mysqli_query($con,"select * from seasoning_categories where id='".$product_details_row['category_id']."' and status='1' and is_active='1'"));    
                        					...
                        					<!-- /Delete Tax Modal -->
												...
												<tr>
													...
													<td class="text-right">
														<a href="edit_seasoning_mix.php?sesoning_id=<?php echo $product_details_row['id']; ?>" class="btn btn-sm btn-white text-success mr-2"><i class="far fa-edit mr-1"></i> Edit</a> 

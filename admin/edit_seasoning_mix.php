...
if(isset($_POST['edit_products'])) {
   ...
   $update_tax_status=mysqli_query($con,"update our_products set category_id='".$product_id."',product_name='".$product_name."',product_image='".$shortname."',prd_qty='".$product_qty."',price='".$product_price."',status='".$product_status."',recepie_ingredient='".$recepie_ingredient."' where id='".$rec_id."' and is_active='1'");
   
    if($update_tax_status==true) {
       
        $_SESSION['alert_msg']='<strong>Success!</strong> Seasoning Product Updated.';
				...
				<div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">Seasoning Mix</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="dashbaord.php">Dashboard</a></li>
									<li class="breadcrumb-item active">Edit Seasoning Mix</li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-12">
						  ...
						  <?php if(isset($_POST['add_products']) || isset($_POST['edit_products']) || isset($_GET['delete_products'])) { ?>
						   ...
						   $sesoning_id=$_GET['sesoning_id'];
						   $seasoning_mix_details=mysqli_fetch_array(mysqli_query($con,"select * from our_products where id='".$sesoning_id."' and status='1' and is_active='1'"));
        						    ...
        						    <form method="post" enctype="multipart/form-data" autocomplete="off">
        						       ...
        						       <div class="col-md-4">
        									<div class="form-group">
        										<label>Seasoning Category <span class="text-danger">*</span></label><br>
        										<select class="form-control" id="product_id" name="product_id" style="width:100%;" required>
    											    <option value="">Select Category</option>
    												<?php 
    												$product_master=mysqli_query($con,"select * from seasoning_categories where is_active='1'");
    												while($product_master_row=mysqli_fetch_array($product_master))
    												{
    												?>    
    												<option value="<?php echo $product_master_row['id']; ?>" <?php if($product_master_row['id']==$seasoning_mix_details['category_id']) { ?> selected <?php } ?>><?php echo $product_master_row['category_name']; ?></option>
    											    <?php } ?>	
    											</select>
        									</div>
        								</div>

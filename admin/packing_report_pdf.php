<?php
    ...
    $pdf->SetAuthor('');
    $pdf->SetTitle('UCS - Packing Report');
    $pdf->SetSubject('Packing Report');
            ...
            <tr>
                ...
                <td>    
					...
					<table>';
				         	...
				         	$html.= '<tr >
						        <td height="20"><strong>Packing Date</strong></td>
						        <td height="20">: '.date('d-m-Y').'</td>
						    </tr>';
                       
						    $html.= '<tr>
						        <td height="20"><strong>Order Total</strong></td>
    ...
    <table border="1" cellpadding="3" width="100%">
                <tbody>
                    <tr>
                        ...
                        <td height="30" style="font-weight: bold;" width="15%" align="center">Reference ID</td>

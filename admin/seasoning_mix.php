...
if(isset($_POST['add_products'])) {
   ...
   VALUES ('2', '$product_id', '$product_name', '$product_qty', '$product_price', '$shortname', '$recepie_ingredient', '$product_status', CURDATE())");
   
   if($insert_products==true) {
       
        $_SESSION['alert_msg']='<strong>Success!</strong> Seasoning Product Added.';
						...
						<div class="row align-items-center">
							<div class="col">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">Add Seasoning Mix</li>
								</ul>
							</div>
						</div>
					</div>
        						       ...
        						       <div class="col-md-4">
        									<div class="form-group">
        										...
        										<select class="form-control" id="product_id" name="product_id" style="width:100%;" required>
    												...
    												{
    												?>    
    												<option value="<?php echo $product_master_row['id']; ?>" ><?php echo $product_master_row['category_name']; ?></option>
    											    <?php } ?>	
    											</select>
        									</div>
        								</div>

<?php
    ...
    if(isset($_GET['status']))
    {
        ...
        $del=mysqli_query($con,"update orders set status='".$status."' where order_id='".$id."' and is_active='1'");
    ...
    if(isset($_POST['shipping_order']))
    {
        ...
        $del=mysqli_query($con,"update orders set status='4',delivery_date='".$ship_date."' where order_id='".$order_id."' and is_active='1'");
     ...
     if(isset($_POST['amount_refund']))
    {
        ...
        $cus_invamount=mysqli_real_escape_string($con,$_POST['cus_invamount']);
            ...
            for($i=0;$i<count($ref_date);$i++)
            {
                ...
                $invoice_details=mysqli_fetch_array(mysqli_query($con,"select * from orders where order_id='".$invno."' and is_active='1'"));
                ...
                $refund_status=mysqli_query($con,"update orders set total_price='".$refund_total."', refund='1', status='5' where user_id='".$invno."' and is_active='1'");
...
<html lang="en">
	<head>
		...
		<title>Eternal Seasoning - Invoice Report</title>
		...
		<div class="main-wrapper">
			...
			<div class="page-wrapper">
				<div class="content container-fluid">
				    <?php 
                        $id=$_GET['invno'];
                        $sql=mysqli_query($con,"select * from orders where order_id='".$id."' and is_active='1'");
							...
							<div class="card">
								<div class="card-body">
									    ...
									    <div class="row">
											...
											<div class="col-md-4">
												<div class="invoice-info">
													...
													<p><b>Delivery Date</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;<?php echo date('d-m-Y',strtotime($row['delivery_date']));?></p>
											...
											<div class="col-md-12">
												<div class="table-responsive">
													<table class="invoice-table table table-bordered" style="width:100%;">
														...
														<tbody>
														    <?php 
                                                                $sql2=mysqli_query($con,"select * from order_items where order_id='".$id."' and is_active='1'");
                                                                $i=1;
                                                                $grand_tot='0';
									...
									<div class="invoice-item">
										<div class="row">
										     <div class="col-lg-12">
									            <a class="btn btn-sm btn-info mr-2" href="invoice_viewpdf.php?invno=<?php echo $row['order_id']?>" target="_blank">

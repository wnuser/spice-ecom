...
<html class="no-js" lang="">
    <head>
        ...
        <title>Eternal Seasoning - World Cusines</title>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-8">
                            <div class="discount-item mb-20" style="text-align: center;">
                                <div class="discount-thumb" style="background: #000000c4;border-radius: 10px;">
                                    <img src="admin/assets/img/cusines_img/<?php echo $cusines_row['cusine_image']; ?>" style="width:420px;height:220px;" alt="<?php echo $cusines_row['cusine_name']; ?>">
                                </div>
                                <div class="discount-content">
                                    <h4 class="title"><?php echo $cusines_row['cusine_name']; ?></h4>
                                    <a href="cusines_categories.php?category=<?php echo $cusines_row['id']; ?>" class="btn rounded-btn">View Categories</a>
                                </div>
                            </div>
                        </div>
